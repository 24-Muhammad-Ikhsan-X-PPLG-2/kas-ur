  ...
  <nav className="border-b-[3px] border-[#171416] bg-[#f8f2e8] px-5 py-4 sm:px-8 lg:px-12">
    <div className="mx-auto flex max-w-300 items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <button
          type="button"
          className="flex min-h-10 items-center gap-2 rounded-md border-2 border-[#171416] bg-[#fffdf8] px-3 text-xs font-black shadow-[3px_3px_0_#171416] transition active:translate-x-0.75 active:translate-y-0.75 active:shadow-none focus-visible:outline-3 focus-visible:outline-[#7a1f3d]"
